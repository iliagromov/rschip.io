      ...
      <!--               <li class="col-sm-6 products__item" data-tabby="2">
                <div class="product-rseco b-product gradient-bg">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-8 col-sm-7"><a class="visible-xs b-product__link" href="/product/rseco.html">Details</a><img class="b-product__img" src="<?php //echo get_template_directory_uri(); 
                                                                                                                                                                ?>/images/media/rseco-small.png" alt=""></div>
                  </div>
