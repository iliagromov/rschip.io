    ...
    <div class="wrapper">
        <div class="powerRowFlex">
            <div class="powerContainer">
                ...
                <div class="powerImg">
                    <picture>
                        <source type="image/png" srcset="assets/images/png/imgPowerBlockChip-lg.png" media="(min-width: 992px)">
                        <source type="image/png" srcset="assets/images/png/imgPowerBlockChip-sm.png" media="(min-width: 768px)"><img src="assets/images/png/imgPowerBlockChip-xs.png" alt="imgPowerBlockChip">
                    </picture>
                </div>
            </div>
        </div>
