<section class="modal modalNews" data-modal="modalNews"> <button class="modalClose icon-close js-modal-close"></button>
    <div class="modalContent">
        <h3 class="modalTitle">BMW M5 tuned by RS chip at our dealer’s car repair shop</h3>
        <div class="modalDate">12 june 2021</div><img src="assets/images/png/imgNewsPopup.png" alt="imgGallary">
        ...
        <img src="assets/images/png/imgNewsPopup2.png" alt="imgGallary"><img src="assets/images/png/imgNewsPopup3.png" alt="imgGallary">
        <p class="page__text">Developing the best possible ECU remap (chiptuning) for a car requires time and
            intimate knowledge of the vehicle you’re tuning. In order to provide high quality ECU remaps, our
